...
const (
	...
	InvoiceUpcoming                             = "invoice.upcoming"                     // Occurs X number of days before a subscription is scheduled to create an invoice that is charged automatically, where X is determined by your subscriptions settings.
